...
/**
 * Servlet implementation class ProductFilterListViewServlet
 */
@WebServlet("/pfilter")
public class ProductFilterListViewServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ProductFilterListViewServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	       ...
	       listCount = pservice.getListCount(filterBrand);
	       else
	       listCount = pservice.getListCount();
	       
	       ArrayList<ProductFull> list = new ArrayList<ProductFull>();
	       if(!filterBrand.isEmpty())
	        list= pservice.selectList(currentPage, limit, filterBrand, filterKey);
	       else
	    	list = pservice.selectList(currentPage, limit, filterKey);
